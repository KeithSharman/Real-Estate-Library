...
const pricingPlans = [
  {
    ...
    period: "per month",
    description:
      "Perfect for small brokerages getting started with structured training.",
    features: [
  ...
  },
  {
    ...
    period: "per month",
    description:
      "Ideal for growing brokerages with comprehensive training needs.",
    features: [
...
const faqs = [
  {
    ...
    answer:
      "We bill monthly or annually. Annual plans save you 20%. You can upgrade, downgrade, or cancel at any time.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We support all major real estate software including Salesforce, HubSpot, MLS platforms, DocuSign, and many more.",
  },
  {
    question: "Do you offer training on our specific tools?",
    answer:
      "Yes! Enterprise plans include custom workflow creation for your specific software stack.",
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 py-8 lg:px-10">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-zinc-600 dark:text-zinc-400">
            Replace inconsistent shadowing with repeatable, software-specific
            training paths. Get your entire team aligned on workflows and tools.
          </p>
        </header>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Ensure every team member follows the same processes for
                listings, transactions, and client management.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Reduce training time from weeks to days with structured,
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Track completion rates, quiz scores, and identify areas where
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Access training materials on any device. Perfect for agents
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Stay compliant with industry regulations and licensing
                requirements.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                New modules added regularly to keep your team current with
                industry changes.
              </p>
            </div>
          </div>
        ...
        <section className="rounded-3xl bg-emerald-600 px-8 py-14 text-center text-white">
          ...
          <p className="mt-4 text-emerald-100">
            Join hundreds of brokerages already using structured training to
